...
const BoxFeatures = forwardRef(({boxTitle, boxDetail}, ref) => {
    return(
        <div ref={ref} className="md:w-1/2 lg:w-1/4 h-60 p-2">
            <div className="hover:-translate-y-2 hover:cursor-pointer duration-300 w-full h-full bg-gradient-to-br from-rose-100 via-rose-400 to-rose-500 rounded p-5 flex shadow-xl">
